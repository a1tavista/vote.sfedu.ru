  ...
  class AllTeachersForStudent
    ...
    def call
      ...
      Teacher.
        ...
        joins('LEFT JOIN "semesters_stages" ON "students_teachers_relations"."semester_id" = "semesters_stages"."semester_id"').
        joins('INNER JOIN "stages" ON ("stages"."id" = "semesters_stages"."stage_id" OR "stages"."id" = "students_teachers_relations"."stage_id")').
